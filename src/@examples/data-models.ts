import { DataModelList } from "../@types/DataModel";

const dataModels: DataModelList = [
  {
  ...
  {
      "dataSource": "HS_PAID_ORGANIC_QUERIES",
      "id": "HS_PAID_ORGANIC_QUERIES",
      "tableConfig": "custom-etl-data-connector.holistic_search_{{CLIENT_NAME}}.paid_organic_queries_yoy",
      "schema": [
        {
          "defaultAggregaton": "count",
          "name": "Date",
        ...
        },
        {
          ...
          "name": "Organic_Impressions",
          "format": "number",
          "description": "Organic_Impressions",
          "label": "Organic Impressions",
          "source": "Search Console",
          "type": "number"
        },
        {
          "defaultAggregaton": "avg",
          "name": "Organic_Min_Position",
          "format": "number",
          "description": "Organic_Min_Position",
          "label": "Organic Min Position",
          "source": "Search Console",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Paid_Clicks_365",
          "format": "number",
          "description": "Paid_Clicks_365",
          "label": "Paid Clicks (LY)",
          "source": "Google Ads",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Paid_Impressions_365",
          "format": "number",
          "description": "Paid_Impressions_365",
          "label": "Paid Impressions (LY)",
          "source": "Google Ads",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Paid_Conversions_365",
          "format": "number",
          "description": "Paid_Conversions_365",
          "label": "Paid Conversions (LY)",
          "source": "Google Ads",
          "type": "number"
        },
        {
        ...
        {
          "defaultAggregaton": "sum",
          "name": "Organic_Clicks_365",
          "format": "number",
          "description": "Organic_Clicks_365",
          "label": "Organic Clicks (LY)",
          "source": "Search Console",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Organic_Impressions_365",
          "format": "number",
          "description": "Organic_Impressions_365",
          "label": "Organic Impressions (LY)",
          "source": "Search Console",
          "type": "number"
        },
        {
          "defaultAggregaton": "avg",
          "name": "Organic_Min_Position_365",
          "format": "number",
          "description": "Organic_Min_Position_365",
          "label": "Organic Min Position (LY)",
          "source": "Search Console",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Holistic_Clicks",
          "format": "number",
          "description": "Holistic_Clicks",
          "label": "Holistic Clicks",
          "source": "Mixed",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Holistic_Clicks_365",
          "format": "number",
          "description": "Holistic_Clicks_365",
          "label": "Holistic Clicks (LY)",
          "source": "Mixed",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Holistic_Impressions",
          "format": "number",
          "description": "Holistic_Impressions",
          "label": "Holistic Impressions",
          "source": "Mixed",
          "type": "number"
        },
        {
          "defaultAggregaton": "sum",
          "name": "Holistic_Impressions_365",
          "format": "number",
          "description": "Holistic_Impressions_365",
          "label": "Holistic Impressions (LY)",
          "source": "Mixed",
          "type": "number"
        }
      ]
  ...
  "dataSource": "GAUA",
  "id": "GAUA",
  "tableConfig": "custom-etl-data-connector.ga_{{CLIENT_NAME}}_us.ga_allcategorization",
  "schema": [
    {
      "defaultAggregaton": "count",
      "name": "date",
